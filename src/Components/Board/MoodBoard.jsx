...
const MoodBoard = () => {
  ...
  return (
    <div className="relative h-screen w-screen overflow-hidden pt-20">
      ...
      <div className="relative z-10 flex flex-col items-center justify-center h-full w-full space-y-6 pt-20 overflow-y-auto">
        <div className="text-white text-2xl font-bold text-center mt-20"> Your Mood Board</div>
